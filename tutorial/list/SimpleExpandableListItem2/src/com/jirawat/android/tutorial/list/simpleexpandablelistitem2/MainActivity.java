package com.jirawat.android.tutorial.list.simpleexpandablelistitem2;
...
public class MainActivity extends ExpandableListActivity {
    ...
    private ExpandableListAdapter createListAdapter(final UsState[] usStates) {
        ...
        return new SimpleExpandableListAdapter(this, 
        		list,
                android.R.layout.simple_expandable_list_item_2, fromMapKey, toLayoutId,
                childList,
    ...
    private List<Map<String, String>> convertToListItems(final UsState[] usStates) {
        ...
        for (final UsState usState : usStates) {
            final Map<String, String> listItemMap = new HashMap<String, String>();
            listItemMap.put(TEXT1, usState.getStateName());
            listItemMap.put(TEXT2, usState.getAbbreviation());
