Demo using the built-in Android android.R.layout.simple_list_item_1.simple_list_item_1 to display a List of Strings in the UI.
...
3. Create a ListAdapter that connects the List of Strings data to simple_list_item1
